      ...
      <main className="broker-layout">
        <BrokerSidebar
          ...
          onLock={() => {
            ...
            setActionMessage(
              language === 'tr'
                ? 'Uygulama kilitlendi. Açmak için app şifrenizi girin.'
                : 'Application locked. Enter your app password to unlock.',
            )
          }}
            ...
            <div className="broker-summary-card compact-card">
              ...
              <div className="broker-summary-row">
                ...
                <div className="broker-summary-meta">
                  PID: {status.server_pid ?? '-'} • R:{status.server_restart_count}/
                  {status.server_retry_limit}
                </div>
              </div>
            </div>
